        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <input
              ...
              className="w-full px-5 py-3.5 rounded-xl bg-white/5 backdrop-blur-md border border-white/20 text-white placeholder-gray-400 focus:border-gold-400 focus:outline-none focus:ring-2 focus:ring-gold-500/30 transition-all shadow-[inset_0_2px_10px_rgba(0,0,0,0.2)]"
            />
          </div>
          <div>
          ...
          >
            <span className="relative z-10 flex items-center justify-center gap-2">
              {submitted ? "Sent!" : "Book Consultation"}
            </span>
          </button>
        </form>
      </div>
